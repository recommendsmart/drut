...
git clone --branch 8.x https://github.com/drupal-composer/drupal-project.git $DRUPAL_BUILD_ROOT
cd $DRUPAL_BUILD_ROOT
git checkout 53f6910c35db73d0b367d5b6f22be4af94dd1af3
...
# Create the directory for browser output.
mkdir --parents $BROWSERTEST_OUTPUT_DIRECTORY
