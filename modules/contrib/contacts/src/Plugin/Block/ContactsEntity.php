...
class ContactsEntity extends BlockBase implements ContainerFactoryPluginInterface, DashboardBlockInterface {
   ...
   *   The class resolver.
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, EntityTypeManagerInterface $entity_type_manager, EntityFormBuilderInterface $form_builder, RequestStack $request_stack, EntityDisplayRepository $entity_display_repository, AccountProxy $current_user, ClassResolverInterface $class_resolver) {
